...
/*************************************************************************
 *
 * Filename: <C:/daily/rwsdk/include/xbox/rwplcore.h>
...
/*--- Automatically derived from: C:/daily/rwsdk/os/xbox/ostypes.h ---*/
#ifndef XBOX_OSTYPES_H
#define XBOX_OSTYPES_H
...
/* Structure alignment */
#define RWALIGN(type, num) __declspec(align(num)) type
...
/* It *does* have a return value, it's in asm! */
#pragma warning( push )
...
/*--- Automatically derived from: C:/daily/rwsdk/os/xbox/osintf.h ---*/
