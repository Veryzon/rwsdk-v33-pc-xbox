...
/*---- start: ./xbox/patchplatform.h----*/

/**
 * \defgroup rppatchxbox Xbox
 * \ingroup rppatch
 *
 * Xbox patch pipeline extension.
 */
...
/**
 * \ingroup rppatchxbox
 * \ref RpPatchXboxPipeline rendering pipelines available within the
 * RpPatch plugin. Use \ref RpPatchGetXboxPipeline to retrieve
 * the \ref RxPipeline s.
 */
enum RpPatchXboxPipeline
{
    rpPATCHXBOXPIPELINEGENERIC      = 0, /**<Xbox generic
                                            patch rendering pipeline.        */
    rpPATCHXBOXPIPELINEMATFX        = 1, /**<Xbox material effect
                                            (single set of texture coordinates)
                                            patch rendering pipeline.        */
    rpPATCHXBOXPIPELINESKINNED      = 2, /**<Xbox skinned
                                            patch rendering pipeline.        */
    rpPATCHXBOXPIPELINESKINMATFX    = 3, /**<Xbox skinned material effect
                                            (single set of texture coordinates)
                                            patch rendering pipeline.        */
    rpPATCHXBOXPIPELINEMAX,
    rpPATCHXBOXPIPELINEFORCEENUMSIZEINT = RWFORCEENUMSIZEINT
};
typedef enum RpPatchXboxPipeline RpPatchXboxPipeline;
...
extern RxPipeline *
RpPatchGetXboxPipeline( RpPatchXboxPipeline xboxPipeline );
