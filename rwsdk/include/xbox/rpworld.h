...
/*************************************************************************
 *
 * Filename: <C:/daily/rwsdk/include/xbox/rpworld.h>
 * Automatically Generated on: Wed Jul 10 10:47:45 2002
 *
 ************************************************************************/
...
/*--- Automatically derived from: C:/daily/rwsdk/world/pipe/p2/xbox/native.h ---*/

/*--- Automatically derived from: C:/daily/rwsdk/world/pipe/p2/xbox/xblights.h ---*/

/*--- Automatically derived from: C:/daily/rwsdk/world/pipe/p2/xbox/nodeXBoxWorldSectorAllInOne.h ---*/
...
extern RxNodeDefinition *RxNodeDefinitionGetXboxWorldSectorAllInOne(void);
...
/*--- Automatically derived from: C:/daily/rwsdk/world/pipe/p2/xbox/nodeXBoxAtomicAllInOne.h ---*/
...
extern RxNodeDefinition *RxNodeDefinitionGetXboxAtomicAllInOne(void);
...
/*--- Automatically derived from: C:/daily/rwsdk/world/pipe/p2/xbox/wrldpipe.h ---*/
...
/*--- Automatically derived from: C:/daily/rwsdk/world/pipe/p2/xbox/xbpipe.h ---*/
/* This is what I keep in memory as part of the instance data setup */
typedef struct RxXboxInstanceData RxXboxInstanceData;
/**
 * \ingroup rpworldxbox
 * \struct RxXboxInstanceData
 * This structure contains Xbox resource specific components.
 */
struct RxXboxInstanceData
{
    /* If you mess with the layout of these, update native.c too */
    
    RwUInt32        minVert;        /**< The vertex index where this
                                         mesh's vertices begin. Needed for
                                         reinstancing not for rendering */

    RwInt32         numVertices;    /**< Number of vertices in the vertex buffer
                                         used by this mesh */

    RwInt32         numIndices;     /**< Number of indices in this mesh */
    
    RxVertexIndex   *indexBuffer;   /**< Index buffer */
        
    RpMaterial      *material;      /**< The material for this instanced data */

    RwUInt32        vertexShader;   /**< Vertex shader - FVF or user defined */
    RwUInt32        pixelShader;    /**< Pixel shader */
};

typedef struct RxXboxVertexFormat RxXboxVertexFormat;

/**
 * \ingroup rpworldxbox
 * \struct RxXboxVertexFormat
 * This structure is used to serialize & reconstruct vertex format
 * handles for vertex buffers.
 */
struct RxXboxVertexFormat
{
    RwUInt32 positions : 1;         /**< positions - yes or no */
    RwUInt32 normals : 1;           /**< normals - yes or no */
    RwUInt32 prelit : 1;            /**< prelit - yes or no */
    RwUInt32 numTexCoordSets : 3;   /**< texture coords - up to 4 sets */
};

typedef struct RxXboxResEntryHeader RxXboxResEntryHeader;
/**
 * \ingroup rpworldxbox
 * \struct RxXboxResEntryHeader
 * This structure contains Xbox resource specific components.
 */
struct RxXboxResEntryHeader
{
    ...
    RwInt32     size;           /**< size in bytes of entire structure + mesh data */

    RwUInt16    serialNumber;   /**< The mesh headers serial number */
    RwUInt16    numMeshes;      /**< The number of meshes */

    RwUInt32    primType;       /**< Primitive type either
                                     D3DPT_TRIANGLESTRIP or
                                     D3DPT_TRIANGLELIST */
    
    RwInt32     numVertices;    /**< Number of vertices in the vertex buffer */

    RwInt32     stride;         /**< Stride of the vertices in the vertex buffer */
    
    RxXboxVertexFormat format;  /**< Format flags of the vertices in the vertex buffer */
    
    void        *vertexBuffer;  /**< Vertex buffer for storing all meshes vertices
                                     N.B. you can still merge additional streams
                                     per mesh on to this one by adding
                                     RxXboxInstanceData->minVert vertices as padding
                                     to the beginning of the additional stream's vertex
                                     buffer */

    RwBool      vertexAlpha;    /**< The prelight data contains alpha */

    RxXboxInstanceData *begin;  /**< First instanced data mesh */ 
    RxXboxInstanceData *end;    /**< One-past-the-last instanced data mesh */
    
    /* numMeshes RxXboxInstanceDatas tacked on the end here when allocated */
    
    /* numMeshes index buffers tacked on after that */
};

typedef RwBool (*_rxXboxAllInOneInstanceCallBack)(void *object,
                                                  RxXboxResEntryHeader *instancedHeader,
                                                  RwBool reinstance);

typedef RwBool (*_rxXboxAllInOneReinstanceCallBack)(void *object,
                                                    RxXboxResEntryHeader *instancedHeader);

/**
 * \ingroup rpworldxbox
 * RxXboxAllInOneLightingCallBack callback function.
 * 
 * \param object Pointer to the object.
 *
 * \see RxXboxAllInOneSetLightingCallBack
 * \see RxXboxAllInOneGetLightingCallBack
 * \see RxNodeDefinitionGetXboxAtomicAllInOne
 * \see RxNodeDefinitionGetXboxWorldSectorAllInOne
 */
typedef void (*RxXboxAllInOneLightingCallBack)(RwObject *object);

/**
 * \ingroup rpworldxbox
 * RxXboxAllInOneRenderCallBack callback function.
 * 
 ...
 *
 * \see RxXboxAllInOneSetRenderCallBack
 * \see RxXboxAllInOneGetRenderCallBack
 * \see RxNodeDefinitionGetXboxAtomicAllInOne
 * \see RxNodeDefinitionGetXboxWorldSectorAllInOne
 */
typedef void (*RxXboxAllInOneRenderCallBack)(RxXboxResEntryHeader *instancedHeader,
                                             void *object,
                                             RwUInt8 type,
                                             RwUInt32 flags);
#ifdef    __cplusplus
...
{
#endif /* __cplusplus */
extern void _rxXboxAllInOneSetInstanceCallBack(RxPipelineNode *node,
                _rxXboxAllInOneInstanceCallBack callback);
extern _rxXboxAllInOneInstanceCallBack _rxXboxAllInOneGetInstanceCallBack(RxPipelineNode *node);

extern void _rxXboxAllInOneSetReinstanceCallBack(RxPipelineNode *node,
                _rxXboxAllInOneReinstanceCallBack callback);
extern _rxXboxAllInOneReinstanceCallBack _rxXboxAllInOneGetReinstanceCallBack(RxPipelineNode *node);

extern void RxXboxAllInOneSetLightingCallBack(RxPipelineNode *node,
                RxXboxAllInOneLightingCallBack callback);
extern RxXboxAllInOneLightingCallBack RxXboxAllInOneGetLightingCallBack(RxPipelineNode *node);

extern void RxXboxAllInOneSetRenderCallBack(RxPipelineNode *node,
                RxXboxAllInOneRenderCallBack callback);
extern RxXboxAllInOneRenderCallBack RxXboxAllInOneGetRenderCallBack(RxPipelineNode *node);

extern RwBool _rwXBDefaultInstance(   RxXboxResEntryHeader *instancedHeader,
                        RwV3d *positions,
                        RwV3d *normals,
                        RpVertexNormal *packedNormals,
                        RwRGBA *color,
                        RwInt32 numTexCoordSets,
                        RwTexCoords **texCoordSets,
                        RwBool reinstance
                        );

extern RwUInt32
RxXboxGetVertexFormatShader( RxXboxVertexFormat f );

extern void
_rxXbDefaultRenderFFPObjectSetUp(RxXboxResEntryHeader *instancedHeader,
                           void *object,
                           RwUInt8 type,
                           RwUInt32 flags);

void
_rxXbDefaultRenderFFPObjectTearDown(RxXboxResEntryHeader *instancedHeader,
                           void *object,
                           RwUInt8 type,
                           RwUInt32 flags);

extern void
_rxXbDefaultRenderFFPMesh(RxXboxResEntryHeader *instancedHeader,
                       RxXboxInstanceData   *mesh,
                       RwUInt32             flags);

extern void
_rxXbDefaultRenderFFPMeshSetUp(RxXboxInstanceData      *mesh,
                                RwUInt32 flags);
                                
extern void
_rxXbDefaultRenderFFPMeshCombinerSetUp(RxXboxInstanceData      *mesh,
                                RwUInt32 flags);
                                
extern void
_rxXbDefaultRenderFFPMeshCombinerTearDown(RxXboxInstanceData      *mesh,
                                RwUInt32 flags);
