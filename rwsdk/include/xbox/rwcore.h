...
/*************************************************************************
 *
 * Filename: <C:/daily/rwsdk/include/xbox/rwcore.h>
 * Automatically Generated on: Wed Jul 10 10:47:44 2002
 *
 ************************************************************************/
...
/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbmetric.h ---*/
typedef struct RwXboxMetrics RwXboxMetrics;
struct RwXboxMetrics
{
    RwUInt32    nothing;
};
...
/*--- Automatically derived from: C:/daily/rwsdk/src/pipe/p2/xbox/nodeXBoxSubmitNoLight.h ---*/
...
RxNodeDefinitionGetXboxSubmitNoLight(void);
...
/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbtexdic.h ---*/

/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbsprite.h ---*/

/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbdevice.h ---*/
typedef struct RwXboxDeviceConfig RwXboxDeviceConfig;
/**
 * \ingroup rwcoredriverxbox
 * \struct RwXboxDeviceConfig
 *
 * The RwXboxDeviceConfig allows the selection of Z-Buffer format,
 * multi-sample mode, refresh rate and other flags passed to
 * CreateDevice as part of the D3DPRESENT_PARAMETERS struct.
 * (See the XDK docs for CreateDevice for the relevant enumerations.)
 *
 * e.g.
 *
 * \verbatim
    ...
    deviceConfig.presentFlags = 0;
    deviceConfig.refreshRateInHz = D3DPRESENT_RATE_DEFAULT;
    
    openParams.displayID = &deviceConfig;
  
    RwEngineOpen(&openParams);
    \endverbatim
 *
 * \see RwEngineOpenParams
 * \see RwEngineOpen
 * \see \ref videomode
 */
struct RwXboxDeviceConfig
{
    RwUInt32    multiSample;     /**< The multisample type to use.
                                      Valid types are those defined by
                                      D3DMULTISAMPLE_TYPE */
    RwUInt32    zBufferFormat;   /**< The Z-buffer format to use.
                                      Valid types are those defined by
                                      D3DFORMAT */
    RwUInt32    presentFlags;    /**< Flags passed to CreateDevice as part
                                      of the D3DPRESENT_PARAMETERS struct.
                                      Allows Widescreen & HDTV output & other handy stuff.
                                      (See the XDK docs for CreateDevice.) */
    RwUInt32    refreshRateInHz; /**< Use D3DPRESENT_RATE_DEFAULT unless you want
                                      to force PAL 60 in which case you should pass 60.
                                      (And ignore the asserts "ERR[D3D]: SetVideoMode
                                      - Current AV setup does not support
...
extern void RwXboxSetStencilClear(RwUInt32 stencilClear);
extern RwUInt32 RwXboxGetStencilClear(void);

/* Get handle to D3D8 device - useful for setting D3D renderstate*/
extern void * RwXboxGetCurrentD3DDevice(void);

extern void RwXboxSetCurrentVertexShader( RwUInt32 vertexShader );
extern RwUInt32 RwXboxGetCurrentVertexShader( void );

extern void RwXboxSetCurrentPixelShader( RwUInt32 pixelShader );
extern RwUInt32 RwXboxGetCurrentPixelShader( void );

/* Dynamic vertex buffers management */
RwUInt32 * RwXboxLockDynamicVertexBuffer( RwUInt32 size );
void RwXboxSetCurrentStream( RwUInt32 stride );
void* RwXboxGetCurrentVertexBuffer( void );

#ifdef    __cplusplus
}
#endif                          /* __cplusplus */

/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbconvrt.h ---*/

/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbcache.h ---*/

#define RWXBOX_NB_STAGES 4
...
#ifndef RWDEBUG
/* RenderState cache */
extern DWORD _RwXbRenderStateCache[D3DRS_MAX];
extern DWORD _RwXbRenderStateCacheBuffer[D3DRS_MAX];

/* texture Stage state cache */
extern DWORD _RwXbTextureStageCache[D3DTSS_MAX][RWXBOX_NB_STAGES];
extern DWORD _RwXbTextureStageCacheBuffer[D3DTSS_MAX][RWXBOX_NB_STAGES];

extern IDirect3DBaseTexture8* _RwXbTextureCache[4];
extern IDirect3DBaseTexture8* _RwXbTextureCacheBuffer[4];

#endif

extern void _rwXbFlushCacheBuffer();
extern void _rwXbCacheInit();

#ifdef RWDEBUG
extern void RwXboxSetCachedRenderState( D3DRENDERSTATETYPE state, DWORD value );
#else
#define RwXboxSetCachedRenderState( state, value ) ( _RwXbRenderStateCacheBuffer[state] = value )
#endif

#ifdef RWDEBUG
extern void RwXboxSetCachedTextureStageState( DWORD stage , D3DTEXTURESTAGESTATETYPE type, DWORD value );
#else
#define RwXboxSetCachedTextureStageState(stage, type, value) ( _RwXbTextureStageCacheBuffer[type][stage] = value )
#endif

#ifdef RWDEBUG
extern void RwXboxSetCachedTexture( DWORD stage, IDirect3DBaseTexture8* tex );
#else
#define RwXboxSetCachedTexture( stage, tex) ( _RwXbTextureCacheBuffer[stage] = tex )
#endif

extern void RwXboxGetCachedTextureStageState( DWORD stage , D3DTEXTURESTAGESTATETYPE type, DWORD* value );
extern void RwXboxGetCachedRenderState( D3DRENDERSTATETYPE state, DWORD* value );
extern void RwXboxGetCachedTexture( DWORD stage, IDirect3DBaseTexture8** tex );


/* New API functions wrapping the D3D functions */
extern void RwXboxDrawIndexedVertices(D3DPRIMITIVETYPE primitiveType, UINT vertexCount, CONST WORD* pIndexData);
extern void RwXboxDrawIndexedVerticesUP(D3DPRIMITIVETYPE primitiveType, UINT vertexCount, CONST void* pIndexData,
                               CONST void* pVertexStreamZeroData, UINT vertexStreamZeroStride);
extern void RwXboxDrawVertices(D3DPRIMITIVETYPE primitiveType, UINT startVertex, UINT vertexCount);
extern void RwXboxDrawVerticesUP(D3DPRIMITIVETYPE primitiveType, UINT vertexCount,
                        CONST void* pVertexStreamZeroData, UINT vertexStreamZeroStride);
extern void RwXboxSetRenderTarget(D3DSurface *renderSurface, D3DSurface *stencilSurface );
...
/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/drvmodel.h ---*/
#ifndef XBOX_DRVMODEL_H
#define XBOX_DRVMODEL_H

#if (defined(RWMEMDEBUG))
/*
Malloc.h, included by xmmintrin.h below gets included
otherwise and clashes with crtdbg.h
*/
#define _INC_MALLOC
#endif
...
#define RwMatrixMultiplyWithSSE(pMatrixOut, pMatrixA, pMatrixB )    \
__asm mov ecx , pMatrixB                                            \
__asm mov ebx , pMatrixA                                            \
__asm mov eax , pMatrixOut                                          \
__asm movaps xmm0,xmmword ptr [ebx ]                                \
__asm movaps xmm2,xmmword ptr [ebx +10h]                            \
__asm movaps xmm3,xmmword ptr [ebx +20h]                            \
__asm movaps xmm5,xmmword ptr [ebx +30h]                            \
__asm movaps xmm1,xmm0                                              \
__asm movaps xmm4,xmm3                                              \
__asm unpcklps xmm0,xmm2                                            \
__asm unpckhps xmm1,xmm2                                            \
__asm unpcklps xmm3,xmm5                                            \
__asm unpckhps xmm4,xmm5                                            \
__asm movlhps xmm1, xmm4                                            \
__asm movaps xmm4, xmm0                                             \
__asm movlhps xmm4, xmm3                                            \
__asm movhlps xmm3, xmm0                                            \
__asm movaps xmm0,xmmword ptr [ecx ]                                \
__asm shufps xmm0,xmm0,0x00                                         \
__asm mulps xmm0,xmm4                                               \
__asm movaps xmm2,xmmword ptr [ecx +10h]                            \
__asm shufps xmm2,xmm2,0x00                                         \
__asm mulps xmm2,xmm3                                               \
__asm movaps xmm5,xmmword ptr [ecx +20h]                            \
__asm shufps xmm5,xmm5,0x00                                         \
__asm mulps xmm5,xmm1                                               \
__asm addps xmm0,xmm2                                               \
__asm movaps xmm2,xmmword ptr [ecx ]                                \
__asm shufps xmm2,xmm2,0x55                                         \
__asm mulps xmm2,xmm4                                               \
__asm addps xmm0,xmm5                                               \
__asm movaps xmm5,xmmword ptr [ecx +10h]                            \
__asm shufps xmm5,xmm5,0x55                                         \
__asm mulps xmm5,xmm3                                               \
__asm movaps xmm6,xmmword ptr [ecx +20h]                            \
__asm shufps xmm6,xmm6,0x55                                         \
__asm mulps xmm6,xmm1                                               \
__asm addps xmm2, xmm5                                              \
__asm movaps xmm5,xmmword ptr [ecx ]                                \
__asm shufps xmm5,xmm5,0xAA                                         \
__asm mulps xmm5,xmm4                                               \
__asm addps xmm2, xmm6                                              \
__asm movaps xmm6,xmmword ptr [ecx +10h]                            \
__asm shufps xmm6,xmm6,0xAA                                         \
__asm mulps xmm6,xmm3                                               \
__asm movaps xmm7,xmmword ptr [ecx +20h]                            \
__asm shufps xmm7,xmm7,0xAA                                         \
__asm mulps xmm7,xmm1                                               \
__asm mov edx, dword ptr [ebx +0Ch]                                 \
__asm addps xmm5, xmm6                                              \
__asm and edx, dword ptr [ecx +0Ch]                                 \
__asm movaps xmm1,xmm0                                              \
__asm unpcklps xmm0,xmm2                                            \
__asm unpckhps xmm1,xmm2                                            \
__asm addps xmm5, xmm7                                              \
__asm movlps qword ptr [eax ], xmm0                                 \
__asm movss dword ptr [eax +8], xmm5                                \
__asm mov dword ptr [eax +0Ch], edx                                 \
__asm shufps xmm0, xmm5, 0x1E                                       \
__asm movaps xmm2, xmmword ptr [ecx +30h]                           \
__asm movaps xmmword ptr [eax +10h], xmm0                           \
__asm shufps xmm2, xmm2, 0xA4                                       \
__asm movlps qword ptr [eax +20h], xmm1                             \
__asm movhps qword ptr [eax +28h], xmm5                             \
__asm shufps xmm1, xmm5, 0x3E                                       \
__asm addps xmm1, xmm2                                              \
__asm movaps xmmword ptr [eax +30h], xmm1
                                            
#if (!defined(_RW_MATMUL_CPU) && !defined(RwMatrixMultiplyMacro))
#define RwMatrixMultiplyMacro(_m, _m1, _m2) \
        RwMatrixMultiplyWithSSE(_m, _m1, _m2)
#endif /* (!defined(_RW_MATMUL_CPU) && !defined(RwMatrixMultiplyMacro)) */

#endif /* (defined(_XBOX)) */

#define RwRwMatrixToD3DMATRIX( _rwm, _d3dm )        \
        (_d3dm)->m[0][0] = -(_rwm)->right.x;        \
        (_d3dm)->m[0][1] = -(_rwm)->right.y;        \
        (_d3dm)->m[0][2] = -(_rwm)->right.z;        \
        (_d3dm)->m[0][3] = 0.0f;                    \
        (_d3dm)->m[1][0] = (_rwm)->up.x;            \
        (_d3dm)->m[1][1] = (_rwm)->up.y;            \
        (_d3dm)->m[1][2] = (_rwm)->up.z;            \
        (_d3dm)->m[1][3] = 0.0f;                    \
        (_d3dm)->m[2][0] = (_rwm)->at.x;            \
        (_d3dm)->m[2][1] = (_rwm)->at.y;            \
        (_d3dm)->m[2][2] = (_rwm)->at.z;            \
        (_d3dm)->m[2][3] = 0.0f;                    \
        (_d3dm)->m[3][0] = (_rwm)->pos.x;           \
        (_d3dm)->m[3][1] = (_rwm)->pos.y;           \
        (_d3dm)->m[3][2] = (_rwm)->pos.z;           \
        (_d3dm)->m[3][3] = 1.0f;
...
#define RwIm2DVertexSetRealRGBA(vert, red, green, blue, alpha)      \
    ((vert)->emissiveColor = (((RwFastRealToUInt32(alpha)) << 24) |  \
...
#define RwIm2DVertexSetIntRGBA(vert, red, green, blue, alpha)   \
    ((vert)->emissiveColor = ((((RwUInt32)(alpha)) << 24) |      \
                              (((RwUInt32)(red)) << 16) |        \
                              (((RwUInt32)(green)) << 8) |       \
                              (((RwUInt32)(blue)))))
...
/*
 * For docs on
 * _mm_sqrt_ss(), _mm_rsqrt_ss()
 * see
 * \\Hera/Technologies/Doc/vcplugin/procpack/htm/html/vcrefarithmeticoperationsforthestreamingsimdextensions.htm
 * _mm_set_ss(), _mm_store_ss
 * see
 * \\Hera/Technologies/Doc/vcplugin/procpack/htm/html/vcrefmemoryandinitializationusingstreamingsimdextensions.htm
 */
...
MACRO_START                                     \
{                                               \
  const __m128 qinput = _mm_set_ss(_input);     \
  const __m128 qroot = _mm_sqrt_ss(qinput);     \
  _mm_store_ss((_root), qroot);                 \
}                                               \
MACRO_STOP
...
{                                               \
  const __m128 qinput = _mm_set_ss(_input);     \
  const __m128 qinv = _mm_rsqrt_ss(qinput);     \
  _mm_store_ss((_recip), qinv);                 \
}                                               \
MACRO_STOP
...
/* We use rwXBOXVERTEX to drive the hardware in 2D mode */
typedef struct
{
    RwReal      x;              /* Screen X */
    RwReal      y;              /* Screen Y */
...
typedef rwXBOXVERTEX    RwIm2DVertex;
...
/*--- Automatically derived from: C:/daily/rwsdk/src/pipe/p2/xbox/pip2model.h ---*/
...
/* We use D3D formats for the instanced versions, to allow hardware T&L */

/**
 * \ingroup rwcorep2xbox
...
struct RxObjSpace3DVertex
{
    RwV3d       pos;              /**< position */
    RwV3d       normal;           /**< normal */
    RwUInt32    emissiveColor;    /**< emissive color*/
    RwReal      u;                /**< u */
    RwReal      v;                /**< v */
};
...
MACRO_START \
{ \
    (_col)->alpha = (RwUInt8)((_vert)->emissiveColor >> 24) & 0xFF; \
    (_col)->red   = (RwUInt8)((_vert)->emissiveColor >> 16) & 0xFF; \
    (_col)->green = (RwUInt8)((_vert)->emissiveColor >>  8) & 0xFF; \
    (_col)->blue  = (RwUInt8)((_vert)->emissiveColor      ) & 0xFF; \
} \
MACRO_STOP

#define RxObjSpace3DVertexSetPreLitColor(_vert, _col) \
    ((_vert)->emissiveColor = (((RwUInt32)(_col)->alpha) << 24) | \
...
MACRO_START \
{ \
    (_col)->red   = ((_vert)->emissiveColor >> 16) & 0xFF; \
    (_col)->green = ((_vert)->emissiveColor >>  8) & 0xFF; \
    (_col)->blue  = ((_vert)->emissiveColor      ) & 0xFF; \
    (_col)->alpha = ((_vert)->emissiveColor >> 24) & 0xFF; \
} \
MACRO_STOP
...
#define RwIm3DVertexGetPos(_vert) (&((_vert)->pos))
#define RwIm3DVertexGetNormal(vert) (&((vert)->normal))

#define RwIm3DVertexCopyRGBA(_dst, _src) (((_dst)->emissiveColor) = ((_src)->emissiveColor))
...
/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbraster.h ---*/
/****************************************************************************
 Global Types
 */
typedef struct RwXboxRasterExtension RwXboxRasterExtension;
/**
 * \ingroup rwcoredriverxbox
 * \struct RwXboxRasterExtension
 * This structure contains Xbox raster specific components.
 */
struct RwXboxRasterExtension
{
    void            *texture;       /**< A pointer that holds the reference
                                         to the IDirect3DTexture8 for the
                                         raster. */
    void            *palette;       /**< A pointer that holds the reference
                                         to the D3DPalette for the
                                         palette */
    void            *lockedBuffer;  /**< Pointer to locked texture buffer */
    void            *lockedBits;    /**< Pointer to DX locked buffer */
    RwUInt8         lockedMipLevel; /**< Locked mip level */
    RwUInt8         dxtFormat;      /**< The D3DFORMAT format for the DXT
                                         texture else 0. */
    RwUInt8         alpha;          /**< If this value is set to 1 the texture
                                         has alpha. If this value is set to 0
                                         the texture does not have alpha. */
    RwUInt8         maxAnisotropy;  /**< Max texture anisotropy value to use
                                         (default of 1 is just isotropic) */
    RwUInt8         numMipLevels;   /**< Number of mipmap levels in raster */
};
...
#define rwMAXTEXTURESIZE 4096

#if !defined(RWDEBUG)
#define RwXboxRasterGetExtension(_r) \
    ((RwXboxRasterExtension *)(((RwUInt8 *)(_r)) + _RwXbRasterExtOffset))
#endif /* defined(RWDEBUG) */
...
extern RwInt32 _RwXbRasterExtOffset;    /* Raster extension offset */
...
#if defined(RWDEBUG)
/* Getting the raster extension */
extern RwXboxRasterExtension *RwXboxRasterGetExtension(RwRaster *raster);
#endif /* defined (RWDEBUG) */
...
/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xb2drend.h ---*/
...
/*--- Automatically derived from: C:/daily/rwsdk/src/pipe/p2/xbox/im3dpipe.h ---*/

/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbrendst.h ---*/
...
void RwXboxRenderStateSetTexture( RwTexture *texture, RwInt32 stage );
...
/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/xbdxttex.h ---*/
...
extern RwTexture *RwXboxDDSTextureRead(const RwChar *name, const RwChar *maskname);

#ifdef    __cplusplus
}
#endif                          /* __cplusplus */

/*--- Automatically derived from: C:/daily/rwsdk/driver/xbox/drvfns.h ---*/
...
/*
 * To convert between RwSurfaceProperties to D3DMATERIAL8
 */
extern RwBool       RwXbSetSurfaceProperties(const RwRGBA *color,
